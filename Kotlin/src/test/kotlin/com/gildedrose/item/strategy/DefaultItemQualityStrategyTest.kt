...
//TODO: This test can be extracted and reused for default strategy descendants
internal class DefaultItemQualityStrategyTest {
    ...
    ) = DefaultItemQualityStrategy(qualityUpdate, hasQualityAfterSellIn)
